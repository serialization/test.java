...
public class UnknownWriteEmptyTest extends common.CommonTest {
    ...
    /*
     * write a file, read it such that the type a and its fields are unknown / lazy. do nothing, write it and read it
     * again.
     */
    @Test
    ...
    /*
     * make instance of A and write it to file. read file such that the type a and its fields are unknown / lazy. do
     * nothing, write it and read it again.
     */
    @Test
    ...
    /*
     * write no instances to file. read file such that the type a and its fields are unknown / lazy. make instance of a,
     * write it and read it again.
     */
    @Test
    ...
    /*
     * make instance of A and write it to file. read file such that the type a and its fields are unknown / lazy. make
     * instance of a, write it and read it again.
     */
    @Test
