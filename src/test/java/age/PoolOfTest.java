...
public class PoolOfTest extends common.CommonTest {
    ...
    /**
     * one can use foreign refs to get a pool of equivalent type; the pool is always one owned by the target OGFile
     */
    @Test
    public void testPoolOfForeignObj() throws Exception {
        ...
        Assert.assertEquals(sg.Ages, sg.pool(age));
        Assert.assertEquals(sg1.Ages, sg1.pool(age));
    }

    /**
     * one can use foreign refs to get a pool of equivalent type
     */
    @Test
    public void testPoolOfForeignObj1() throws Exception {
        ...
        Assert.assertNotNull(sg.pool(bb));
        Assert.assertFalse(sg.contains(bb));
    }
