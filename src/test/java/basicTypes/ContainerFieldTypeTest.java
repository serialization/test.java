...
public class ContainerFieldTypeTest extends common.CommonTest {
    ...
    /**
     * Make instances of containers and ensure that their fieldtype's size method returns the correct number of
     * containers
     */
    @Test
    public void testSize() throws Exception {
        final Path currentPath;
        try (OGFile sg = OGFile.open(tmpFile("fieldtype"), Mode.Create, Mode.Write)) {
        ...
        try (OGFile sg = OGFile.open(currentPath, Mode.Read)) {
            ...
            for (FieldDeclaration<?> f : sg.BasicContainerTypess.allFields()) {
    ...
    /**
     * Make instances of containers and ensure that their fieldtype's iterator method returns an iterator that iterates
     * over the correct number of elements
     */
    @Test
